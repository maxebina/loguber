		...
		<div class="page noticias">
    		...
    		<section>
                ...
                <div class="data-noticia interno mb-20">
                    <i class="fa fa-calendar"></i> Publicado no dia 15/08/2018
                </div>
                ...
                <img src="img/como-elaborar-boas-rotas-de-entrega-e-reduzir-custos-logisticos.jpg" class="noticia-interno-img">
                <p>
                ...
                <p>
                    <strong>1. Escolha uma localização eficiente</strong>
                </p>
                <p>
                ...
                <p>
                    <strong>2. Utilize softwares para realizar planejamentos</strong>
                </p>
                <p>
                ...
                <ul>
                    <li>
                        <strong>Reduzir os custos operacionais:</strong> pois será necessária uma equipe menor para o planejamento das entregas;
                    </li>
                    <li>
                        <strong>Aumentar a sua eficiência:</strong> com a realização das entregas em menos tempo, o faturamento tende a ser maior;
                    </li>
                    <li>
                        <strong>Agilizar a operação de roteirização e entrega;</strong>
                    </li>
                    <li>
                        <strong>Alavancar a produtividade da equipe:</strong> já que diminuirá a necessidade de contratação de mão de obra ou uso de horas extras de motoristas e entregadores.
                    </li>
                </ul>
                <p>
                    <strong>3. Teste as rotas mais efetivas e econômicas</strong>
                </p>
                <ul>
                    <li>
                ...
                <p>
                    <strong>4. Use o tipo de veículo adequado</strong>
                </p>
                <p>
